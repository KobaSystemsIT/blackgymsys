	...
	return <div>
		<div className='gran-footer'>
			...
			<footer className="footer footer-center text-base-content">
				<div className='grid grid-cols-3 items-end'>
					<div className="lg:flex lg:w-[65%] md:flex md:w-[75%] w-[55%]">
						<a href="/"><img src={logo} /></a>
					</div>
					<div className="grid grid-flow-col gap-6 text-base">
						<div className='flex gap-2'>
							...
							<a href="https://wa.me/529616603718" className='flex'>Black Gym</a>
						</div>
						<div className='flex gap-2'>
							...
							<a href="" className='flex'>Black Gym</a>
						</div>
						<div className='flex gap-2'>
		...
		<div className='min-footer'>
			<footer className="footer footer-center p-5 text-base-content rounded">
				<div className="lg:flex lg:w-[65%] md:flex md:w-[20%] w-[55%]">
					<a href="/"><img src={logo} /></a>
				</div>
				<div className="grid grid-flow-col gap-6 text-base">
						<div className='flex gap-2'>
